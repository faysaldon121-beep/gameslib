...
interface RequirementsListProps {
  title: string;
  requirements: Game['system_requirements']['minimum'];
}
...
export default function GamePage({ slug }: GamePageProps) {
  ...
  const hasFeatures = game.game_description.long.features && game.game_description.long.features.length > 0;
      ...
      <div className="bg-gray-900 font-sans text-gray-300">
        <div className="container mx-auto p-4 md:p-8">
          <header className="mb-8">
            <p className="text-red-500 font-semibold">{game.game_category}</p>
            <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight">{game.game_title}</h1>
          </header>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <main className="w-full lg:w-2/3 space-y-12">
              ...
              <section>
                ...
                <p className="text-lg text-gray-400 whitespace-pre-line">{game.game_description.long.story}</p>
              </section>
              ...
              {hasFeatures && (
                <section>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-lg text-gray-400">
                    {game.game_description.long.features.map((feature, index) => (
            ...
            <aside className="w-full lg:w-1/3">
              <div className="sticky top-8 space-y-6">
                <img src={game.image_links.poster} alt={`${game.game_title} Poster`} className="w-full rounded-lg shadow-xl" />
